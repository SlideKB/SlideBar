					...
					for (int i = 0; i < selected.length; i++) {
						...
						for (SlideBarPlugin p : temp) {
							if (p.getLabelName().equals(element)) {
								...
								try {
									chckbxAlwaysRun
											.setSelected(SettingsHelper.isAlwaysRun(p.getClass().getCanonicalName()));
								} catch (Exception e2) {
								...
								try {
									textField.setText(
											SettingsHelper.getUsedSliderAtIndex(p.getClass().getCanonicalName(), 0));
								} catch (Exception e3) {
									textField.setText("");
								}
								...
								try {
									textField_1.setText(
											SettingsHelper.getUsedSliderAtIndex(p.getClass().getCanonicalName(), 1));
								} catch (Exception e3) {
									textField_1.setText("");
								}
								...
								try {
									textField_2.setText(
											SettingsHelper.getUsedSliderAtIndex(p.getClass().getCanonicalName(), 2));
								} catch (Exception e3) {
									textField_2.setText("");
								}
								...
								try {
									textField_3.setText(
											SettingsHelper.getUsedSliderAtIndex(p.getClass().getCanonicalName(), 3));
								} catch (Exception e3) {
									textField_3.setText("");
								}
