...
public class Slider {
	...
	public void bumpRight(int milliseconds){ MainBack.arduino.bumpRight(milliseconds);}

	public void bumpLeft(int milliseconds){ MainBack.arduino.bumpLeft(milliseconds);}
	...
	public int getPartIndex(){return MainBack.arduino.getPartIndex();}

	public int getPartIndex(int numberOfParts){return MainBack.arduino.getPartIndex(numberOfParts);}
